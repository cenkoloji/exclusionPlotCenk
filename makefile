...
Wellcome:
	@echo -e "\033[40m\033[0;1;21m -------------------------------------------------------------------- \033[0m"
	@echo -e "\033[40m\033[0;1;22m Makefile script to compile the CAST analysis library and binaries \033[0m"
	@echo -e "\033[54m\033[0;1;23m 2nd of November 2012 \033[0m"
	@echo -e "\033[40m\033[0;1;24m -------------------------------------------------------------------- \033[0m"
	@echo -e "\033[47m\033[0;1;25m ----------------------------------   \033[0m"
	@echo -e "\033[47m\033[0;1;26m  Cenk Yildiz \033[0m"
	@echo -e "\033[47m\033[0;1;27m  cenk.yildiz@cern.ch   \033[0m"
	@echo -e "\033[47m\033[0;1;28m  Nice color stuff taken from Javier Galan's makefiles   \033[0m"
	@echo -e "\033[47m\033[0;1;29m ----------------------------------  \033[0m"
	@echo -e "\033[47m\033[0;1;40m ----------------------------------  \033[0m"
	@echo -e "\033[47m\033[0;1;41m ----------------------------------  \033[0m"
	@echo -e "\033[47m\033[0;1;42m ----------------------------------  \033[0m"
	@echo -e "\033[47m\033[0;1;43m ----------------------------------  \033[0m"
	@echo -e "\033[47m\033[0;1;44m ----------------------------------  \033[0m"
	@echo -e "\033[47m\033[0;1;45m ----------------------------------  \033[0m"
	@echo
...
$(CAST_OBJ)/castDetector.o: makefile
...
$(CAST_OBJ)/castExposure.o: makefile
...
$(CAST_OBJ)/castMagnet.o: makefile
