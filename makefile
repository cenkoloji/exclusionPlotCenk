...
OBJS =  $(CAST_OBJ)/castConversion.o $(CAST_OBJ)/castDetector.o $(CAST_OBJ)/castExposure.o $(CAST_OBJ)/castGas.o $(CAST_OBJ)/castLike.o $(CAST_OBJ)/castMagnet.o $(CAST_OBJ)/castTracking.o $(CAST_OBJ)/castProfile.o
BINARIES =  $(CAST_BIN)/testLike $(CAST_BIN)/singleDetector $(CAST_BIN)/density2mass

#defining compiling targets
all: Wellcome castTracking castExposure castMagnet castDetector castGas castConversion castGas castLike castProfile libCAST programs
...
$(CAST_OBJ)/castGas.o: $(CAST_SRC)/castMagnet.cxx $(CAST_INC)/castMagnet.h $(CAST_SRC)/castGas.cxx $(CAST_INC)/castGas.h makefile
	@echo -e "\033[40m\033[0;31m  Compiling castGas object ........\033[0m"
	@g++ $(CPPFLAGS) -c $(INC_DIRS) -o $(CAST_OBJ)/castGas.o $(CAST_SRC)/castGas.cxx
 
$(CAST_OBJ)/castConversion.o : $(CAST_SRC)/castMagnet.cxx $(CAST_INC)/castMagnet.h $(CAST_SRC)/castGas.cxx $(CAST_INC)/castGas.h $(CAST_SRC)/castConversion.cxx $(CAST_INC)/castConversion.h   makefile
...
$(CAST_OBJ)/castProfile.o : $(CAST_SRC)/castGas.cxx $(CAST_INC)/castGas.h $(CAST_INC)/castProfile.h $(CAST_SRC)/castProfile.cxx  makefile
...
$(CAST_LIB)/libCAST.so: $(CAST_SRC)/castConversion.cxx $(CAST_INC)/castConversion.h $(CAST_SRC)/castDetector.cxx $(CAST_INC)/castDetector.h $(CAST_SRC)/castGas.cxx $(CAST_INC)/castGas.h $(CAST_SRC)/castExposure.cxx $(CAST_INC)/castExposure.h $(CAST_SRC)/castMagnet.cxx $(CAST_INC)/castMagnet.h $(CAST_SRC)/castTracking.cxx $(CAST_INC)/castTracking.h $(CAST_SRC)/castLike.cxx $(CAST_INC)/castLike.h $(CAST_INC)/castProfile.h $(CAST_SRC)/castProfile.cxx makefile
